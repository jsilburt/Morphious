...
imagedir = "/PATH TO YOUR IMAGES HERE/";
clusterdir= "/PATH TO MORPHIOUS GENERATED CLUSTER COORDINATIONS/TIME STAMP/"; //this folder will contain the sudirectorys "focal", "proximal", "combined" if applicable
outputpath = "/PATH TO SAVE OUTPUT FILES/";
clusters = newArray("focal", "proximal", "combined"); //clusters generated by MORPHIOUS

batchmode = false; //set to true to set imageJ to headless mode to hide the analysis.
